...
const Key keymaps[][ROWS][COLS] PROGMEM = {
  ...
  (___,             Key_1,           Key_2,             Key_3,         Key_4, Key_5,     Key_Escape,        // R1
...
void setup() {
  ...
  // FIXME
  static const Key require_right[] PROGMEM =
    {
  ...
  static const Key require_left[] PROGMEM =
    {
     Key_6, Key_7, Key_8, Key_9, Key_0, // numlock
     Key_F, Key_G, Key_C, Key_R, Key_L, Key_Slash,
     Key_D, Key_H, Key_T, Key_N, Key_S, Key_Minus,
     Key_B, Key_M, Key_W, Key_V, Key_Z, Key_Equals,
     Key_NoKey
  };
